...
// Skill-ID alias, so callers of this package need not import toolbridge for
// the skill its own doc comments and tests name most.
const SkillMarketData = toolbridge.SkillMarketData
